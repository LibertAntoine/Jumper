<template>
  <div
    class="mb-4 flex w-full flex-col gap-1 border-b px-1 pb-4"
    v-if="selectedAction"
  >
    ...
    <p class="text-sm text-slate-400 dark:text-slate-500">Edit your profile</p>
  </div>
  <div class="flex flex-col gap-2"> 
    <div class="w-full">
      <div class="relative flex h-[400px] w-full overflow-hidden rounded-md">
...
const { selectedAction } = props.actionsComposable
